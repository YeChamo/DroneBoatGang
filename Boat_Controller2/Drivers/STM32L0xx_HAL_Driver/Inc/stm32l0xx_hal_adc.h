...
#define ADC_CHANNEL_6           ((uint32_t)(ADC_CHSELR_CHSEL6))
#define ADC_CHANNEL_7           ((uint32_t)(ADC_CHSELR_CHSEL7))
#define ADC_CHANNEL_8           ((uint32_t)(ADC_CHSELR_CHSEL8))
#define ADC_CHANNEL_9           ((uint32_t)(ADC_CHSELR_CHSEL9))
